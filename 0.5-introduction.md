...
> \[…\] the aid of a computer, far from replacing the creative act of the artist, permits the latter rather to liberate himself from the slavery of a combinatory search, allowing him also the best chance of concentrating on this “clinamen” which, alone, can make of text a true work of art.[170]

In the tradition of the Oulipo, this work’s translation is presented in *The New Media Reader*[171] (and in its original form, in the Oulipo’s *Atlas de littérature potentielle* compendium)[172] without the final solution – in other words, the potential forms the story may take are more important than the final outcome of the work.[173]

Paul Fournel provides a taxonomy of the roles played by computers in the Oulipian work carried out at the Centre Pompidou, including by Calvino and Queneau.[174] He distinguishes between the role of ‘aided reading’ and ‘aided creation’. Aided reading brings a computer into the interpretation of existing literary material, such as in enabling an audience to generate one of the many available sonnets from *One Hundred Thousand Billion Poems* on cue, whereas aided creation invites a computational element into the creation of work (as with Calvino’s *Burning of the Abominable House*).[175] Fournel distinguishes between three different modes of engagement with the computer in this manner. The first, as seen with Calvino, is ‘Author – Computer – Work’; in this particular case, the computer is used to generate scenarios, which are selected by the author. In the second type, ‘Author – Computer – Work – Computer – Computer – Reader’ the reader interacts with a computer to, for example, solve mysteries (in a manner now familiar to anyone who has played a text-based computer mystery game).[176] The third type is ‘more technically complex’;[177] the ‘Author – Computer – Reader – Computer – Work’ format is used to create myriad short stories according to the readers’ wishes.[178]
...
Using the technique of analogy, for example, leads to the absurd situation where ‘Any action, any characteristic, can become the sign of terrorist activity – from buying a one-way plane ticket to reading online material.’[215] The scale of inferences is potentially absurd:
...
[155] See Appendix C for code I have written in Python which generates random iterations of *Cent mille milliards de poèmes* based on Queneau’s original text.
...
[163] Italo Calvino, *The Complete Cosmicomics*, trans. Martin McLaughlin, Tim Parks, and William Weaver, Penguin Modern Classics (London ; New York: Penguin Classics, 2009). The Cosmicomics were written between 1964-5
...
[167] Calvino’s entry into the Oulipo: Dennis Duncan, ‘Calvino, Llull, Lucretius: Two Models of Literary Combinatorics’, *Comparative Literature* 64, no. 1 (2012): 93.
...
[170] Italo Calvino, ‘Prose and Anticombinatorics’, in *The New Media Reader*, ed. Noah Wardrip-Fruin and Nick Montfort (Cambridge, MA: MIT Press, 2003), 187. The use of a term derived from physics (such as clinamen) in relation to a work of literature is a classic trait of Calvino. His Cosmicomics sought to present a range of scientific and mathematical principles in literary form, often with formal constraints that cause, for example, stories’ structures to mirror each other, or for the motif of an unwinding spiral to be present throughout a work.

[171] Calvino, ‘Prose and Anticombinatorics’. Note that in this tome, the story is entitled ‘The Fire in the Cursed House’.

[172] Oulipo, *Atlas de littérature potentielle*, ed. Noël Arnaud, First, Collection Idées 439 (Paris: Gallimard, 1981).

[173] This was not always the case with Calvino’s work after joining the Oulipo, although heavy formal constraints can be found in many of his stories, including *If on a winter’s night a traveller* and many of the Cosmicomics*.* Italo Calvino, *If on a Winter’s Night a Traveler*, trans. William Weaver, Array (New York: Harcourt Brace Jovanovich, 1981); Calvino, *The Complete Cosmicomics*.

[174] Fournel, ‘Computer and Writer: The Centre Pompidou Experiment’.

[175] An example of this in practice can be found in Appendix X of this thesis, which contains a PHP-coded version of Queneau’s poem.

[176] Fournel, ‘Computer and Writer: The Centre Pompidou Experiment’, 182.
...
[180] Stephen A. Gage, ‘Constructing the User’, *Systems Research and Behavioral Science* 24 (2007): 313–22.
...
[198] Apple Inc., ‘Software License Agreement For iTunes EA1067’ (Apple Inc, 9 October 2013), sec. F9, http://images.apple.com/legal/sla/docs/iTunes.pdf.this provision has been part of Apple EULAs for many years, and can be found in nearly every software license the company issues.
...
[256] Van Neistat, *A Space Program*, Documentary, Adventure, Drama, (2016).

[257] Tom Sachs, *Space Program: Mars*, Various, 16 June 2012.
